...
symbol = 'FLM/USDT'            # 거래 코인
stablecoin = 'USDT'            # 스테이블코인

martin_limit = 0               # 마틴 리밋
martin_ratio = 1               # 마틴 배율

ikson_start = 11             # 시작 익절 카운트
ikson_stop = 0              # 정지 익절 카운트
        ...
        if count3 > count4: # 롱스타트
            ...
            while True:
                try:
                    ...
                    # 숏에서 익절
                    elif long_amount == 0 and short_amount > 0 and symbol_price <= reference_price:
                        count3 += 1
                        if count == 1:
                            count1_1 += 1
                        elif count == 0:
                    ...
                    # 롱에서 익절
                    elif short_amount == 0 and long_amount > 0 and symbol_price >= reference_price * (1 + switching_point): 
                        count4 += 1
                        if count == 1:
                            count1_1 += 1
                        elif count == 0:
                    ...
                    # 숏에서 손절
                    elif long_amount == 0 and symbol_price >= reference_price * (1 + (switching_point + target_point)) and count >= switching_count:
                        count2_1 += 1
                        count4 += 1
                    ...
                    # 롱에서 손절
                    elif short_amount == 0 and symbol_price <= reference_price * (1 - target_point) and count >= switching_count:
                        count2_1 += 1
                        count3 += 1
                        ikson_list.insert(0,0)
                        if len(ikson_list) > ikson_range:
            ...
            while True:
                try:
                    ...
                    # 롱에서 익절
                    elif short_amount == 0 and long_amount > 0 and symbol_price >= reference_price:
                        count4 += 1
                        if count == 1:
                            count1_1 += 1
                        elif count == 0:
                    ...
                    # 숏에서 익절
                    elif long_amount == 0 and short_amount > 0 and symbol_price <= reference_price * (1 - switching_point): 
                        count3 += 1
                        if count == 1:
                            count1_1 += 1
                        elif count == 0:
                    ...
                    # 숏에서 손절
                    elif long_amount == 0 and symbol_price >= reference_price * (1 + target_point) and count >= switching_count:
                        count4 += 1
                        count2_1 += 1
                        ikson_list.insert(0,0)
                        if len(ikson_list) > ikson_range:
                    ...
                    # 롱에서 손절
                    elif short_amount == 0 and symbol_price <= reference_price * (1 - (switching_point + target_point)) and count >= switching_count:
                        count3 += 1
                        count2_1 += 1
                        ikson_list.insert(0,0)
                        if len(ikson_list) > ikson_range:

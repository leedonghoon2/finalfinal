...
# 설정값
target_point =  0.03           # 익절 지점
switching_point =  0.0115      # 스위칭 지점
switching_ratio =  2.44        # 스위칭 배율
switching_count =  1           # 스위칭 횟수
leverage = 20                  # 레버리지
start = 0.085                  # 시작 물량 비율

symbol = 'INJ/USDT'            # 거래 코인

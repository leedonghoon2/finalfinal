...
while True:
    ...
    try:
        ...
        exchange.create_market_buy_order(symbol, long_amount)           # 초기 롱 물량 매수
    ...
    print("2번 스위칭 후 익절 %d회"%(count1_2))
    print("3번 스위칭 후 익절 %d회"%(count1_3))
    print("4번 스위칭 후 익절 %d회"%(count1_4))
    print("5번 스위칭 후 익절 %d회"%(count1_5))
    print("6번 스위칭 후 익절 %d회"%(count1_6))
    print("----------------------")

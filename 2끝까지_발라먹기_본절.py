    ...
    if count3 >= count4:
        ...
        while True :
            try:
                        ...
                        if reference_price >= (reference_price_long + 익절갭 * 본절매수발동트리거) and (count_본절매수 <= 2):
                            count_본절매수 += 1
                        ...
                        if symbol_price <= reference_price_long - 익절갭 or (count_본절매수 >= 1 and reference_price <= reference_price_long):
                                # print("매수조건 충족")
                                params = {
                                            'positionSide': 'SHORT'
                                        }
    ...
    if count3 < count4:
        ...
        while True :
            try:
                        ...
                        if reference_price <= reference_price_short - 익절갭 * 본절매수발동트리거 and (count_본절매수 <= 2):
                            count_본절매수 += 1
                        ...
                        if symbol_price >= reference_price_short + 익절갭 or (count_본절매수 >= 1 and reference_price >= reference_price_short):
                            # print("매수조건 충족")
